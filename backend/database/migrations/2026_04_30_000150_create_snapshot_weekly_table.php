...
return new class extends Migration
{
    ...
    {
        Schema::create('snapshot_weekly', function (Blueprint $table) {
            ...
            $table->unique(['instrument_id', 'symbol'], 'uq_snapshot_weekly_instrument_symbol');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('snapshot_weekly');
    }
};
