...
return new class extends Migration
{
    ...
    {
        Schema::create('snapshot_monthly', function (Blueprint $table) {
            ...
            $table->unique(['instrument_id', 'symbol'], 'uq_snapshot_monthly_instrument_symbol');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('snapshot_monthly');
    }
};
