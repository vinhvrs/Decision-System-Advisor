...
return new class extends Migration
{
    ...
    {
        Schema::create('snapshot_annual', function (Blueprint $table) {
            ...
            $table->unique(['instrument_id', 'symbol'], 'uq_snapshot_annual_instrument_symbol');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('snapshot_annual');
    }
};
