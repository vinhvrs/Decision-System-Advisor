...
type IndicatorsTabProps = { embedded?: boolean };

export default function IndicatorsTab({ embedded = false }: IndicatorsTabProps) {
  ...
  return (
    <div
      className={
        embedded
          ? "bg-[#0b0e14] text-gray-200 py-10 px-4 phone:px-6"
          : "min-h-screen bg-[#0b0e14] text-gray-200 py-16 px-6"
      }
    >
