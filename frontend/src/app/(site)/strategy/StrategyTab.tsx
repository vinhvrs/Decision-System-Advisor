...
type StrategyTabProps = { embedded?: boolean };

export default function StrategyTab({ embedded = false }: StrategyTabProps) {
  ...
  return (
    <div
      className={
        embedded
          ? "bg-[#0b0e14] px-4 py-10 text-gray-200 phone:px-6"
          : "min-h-screen bg-[#0b0e14] px-6 py-16 text-gray-200"
      }
    >
